...
module Jobs
  class ZendeskJob < ::Jobs::Base
    ...
    def push_topic!(topic_id)
      ...
      if topic.present? && DiscourseZendeskPlugin::Helper.category_enabled?(topic.category_id)
    ...
    def push_post!(post_id)
      ...
      return if !DiscourseZendeskPlugin::Helper.category_enabled?(post.topic.category_id)
